      ...
      <div style={{ maxWidth: 760, margin: "0 auto" , width: "100%" }}>
        ...
        {!isLoading &&
          ...
          <div key={w.name}  style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: C.panel, border: `1px solid ${C.border}`, borderRadius: 10, padding: "16px 18px", marginBottom: 10,  }}>
            <div style={{ display: "flex", alignItems: "center", gap: 13, cursor: "pointer"}} onClick={() => navigate(`/workspaces/${w._id}/board`)}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div
                  title="Settings"
                  onClick={() => navigate(`/workspaces/${w?._id}/settings`)}
                  style={{
                    cursor: "pointer",
                  }}
              >
